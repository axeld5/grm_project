...
if __name__ == "__main__":    
    ...
    epochs = 5
    perf_dict = evaluate_models(list_of_reviews, num_node_features, num_classes, device, epochs=epochs, batch_size=batch_size, num_loops=3)
    show_boxplot(perf_dict, x="model_name", y="accuracy")
    perf_dict = evaluate_edge_model(list_of_reviews, num_node_features, num_classes, device, epochs=epochs, batch_size=batch_size, num_loops=3)
    show_boxplot(perf_dict, x="model_name", y="accuracy")